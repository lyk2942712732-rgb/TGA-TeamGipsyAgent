"""TGA3 control-plane HTTP/WebSocket/MCP application (frontend integration comes later)."""
...
def create_app(
    ...
    *,
    ...
    @app.post("/tasks/{task_id}/prompts")
    ...
    @app.get("/tasks/{task_id}/dialogue")
    ...
    @app.get("/tasks/{task_id}/dialogue/stream")
    ...
    @app.post("/tasks/{task_id}/agents/{agent_id}/pause")
    ...
    @app.post("/tasks/{task_id}/agents/{agent_id}/resume")
    ...
    @app.post("/tasks/{task_id}/agents/{agent_id}/model")
    ...
    @app.post("/tasks/{task_id}/stop", status_code=204)
