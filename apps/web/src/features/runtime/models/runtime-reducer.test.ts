...
const base = () => normalizeRuntimeSnapshot({
  ...
  solvers: [{ task_id: "task", solver_id: "supervisor", definition_id: "supervisor", orchestration_role: "supervisor", specialties: [], parent_solver_id: null, assigned_intent_id: null, status: "running", current_summary: "", model_snapshot: {}, skill_snapshot: {}, tool_policy: {}, budget_usage: {}, timestamps: {} }],
