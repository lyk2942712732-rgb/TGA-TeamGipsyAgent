...
describe("useTaskRuntime", () => {
  ...
  it("does not open or reconnect SSE for a terminal task", async () => {
    api.taskRuntime.mockResolvedValue(store("failed"));
    const { result, unmount } = renderHook(() => useTaskRuntime("task"));
    await flush();
