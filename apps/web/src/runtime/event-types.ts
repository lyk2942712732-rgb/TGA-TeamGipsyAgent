...
export type RuntimeTask = { id: string; name: string; mode: TaskMode; prompt: string; files: SessionFile[]; task_entry_url?: string | null; goal?: string; schema_version?: number; model_snapshot?: { provider: string; model: string; verification_id: string; verified_at: string }; mcp_capabilities?: { catalog_version: string; server_ids: string[]; tools: Array<{ provider_name: string; server_id: string; method: string; description?: string }> }; mode_config?: ModeConfig; execution_policy?: ExecutionPolicy };
